...
(function () {
  //This function is for the adative tab bar extension color support.
  function updateAccentColor() {
    ...
    if (accentColor === '' && prefersDarkMode) {
      document.documentElement.style.setProperty('--lwt-accent-color', '#000000');
    } else if (accentColor === '' && !prefersDarkMode) {
      document.documentElement.style.setProperty('--lwt-accent-color', '#FFFFFF');
    }
  }
  updateAccentColor(); 

  window.matchMedia('(prefers-color-scheme: dark)').addEventListener('change', updateAccentColor);

  function checkAndUpdateAccentColor(mutationsList) {
...
#vertical-tabs-list .all-tabs-item .all-tabs-secondary-button[muted] {
  list-style-image: url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="18px" height="18px" viewBox="0 0 18 18"><path fill-opacity="context-fill-opacity" fill="context-fill" d="M3.52,5.367c-1.332,0-2.422,1.09-2.422,2.422v2.422c0,1.332,1.09,2.422,2.422,2.422h1.516l4.102,3.633V1.735L5.035,5.367H3.52z"/><path fill="context-fill" fill-rule="evenodd" d="M12.155,12.066l-1.138-1.138l4.872-4.872l1.138,1.138 L12.155,12.066z"/><path fill="context-fill" fill-rule="evenodd" d="M10.998,7.204l1.138-1.138l4.872,4.872l-1.138,1.138L10.998,7.204z"/></svg>') !important;
  transform: none !important;
  opacity: 0.7;
  margin-inline-start: -2px;
}
#vertical-tabs-list
  ...
  list-style-image: url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 12 12"><path fill-opacity="context-fill-opacity" fill="context-fill" d="M2.128.13A.968.968 0 0 0 .676.964v10.068a.968.968 0 0 0 1.452.838l8.712-5.034a.968.968 0 0 0 0-1.676L2.128.13z"/></svg>') !important;
