...
`;
  ...
  function init() {
    ...
    window.matchMedia('(min-width: 1000px)').addEventListener('change', function (event) {
  ...
  var style = document.getElementById("macos-theme-style");
  if (!style) {
    style = document.createElement("style");
    style.id = "macos-theme-style";
    style.type = "text/css";
